...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.url_vertical_layout = QtWidgets.QFrame(self.centralwidget)
        self.url_vertical_layout.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.url_vertical_layout.setFrameShadow(QtWidgets.QFrame.Raised)
        self.url_vertical_layout.setObjectName("url_vertical_layout")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.url_vertical_layout)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.url_lbl = QtWidgets.QLabel(self.url_vertical_layout)
        self.url_lbl.setObjectName("url_lbl")
        self.horizontalLayout.addWidget(self.url_lbl)
        self.game_combobox = QtWidgets.QComboBox(self.url_vertical_layout)
        self.game_combobox.setObjectName("game_combobox")
        self.horizontalLayout.addWidget(self.game_combobox)
        self.expansion_combobox = QtWidgets.QComboBox(self.url_vertical_layout)
        self.expansion_combobox.setObjectName("expansion_combobox")
        self.horizontalLayout.addWidget(self.expansion_combobox)
        self.verticalLayout.addWidget(self.url_vertical_layout)
        ...
        self.gridLayout_4.addWidget(self.by_rarity, 4, 0, 1, 1)
        self.by_expansion = QtWidgets.QPushButton(self.sort_frame)
        self.by_expansion.setObjectName("by_expansion")
        self.gridLayout_4.addWidget(self.by_expansion, 6, 0, 1, 1)
        self.set_language = QtWidgets.QPushButton(self.sort_frame)
        self.set_language.setObjectName("set_language")
        self.gridLayout_4.addWidget(self.set_language, 10, 0, 1, 1)
        self.line_2 = QtWidgets.QFrame(self.sort_frame)
        ...
        self.gridLayout_4.addWidget(self.pushButton, 15, 0, 1, 1)
        self.set_extra = QtWidgets.QPushButton(self.sort_frame)
        self.set_extra.setObjectName("set_extra")
        self.gridLayout_4.addWidget(self.set_extra, 12, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_4.addItem(spacerItem1, 7, 0, 1, 1)
        self.duplicate_line = QtWidgets.QPushButton(self.sort_frame)
        self.duplicate_line.setObjectName("duplicate_line")
        self.gridLayout_4.addWidget(self.duplicate_line, 14, 0, 1, 1)
        self.by_number = QtWidgets.QPushButton(self.sort_frame)
        self.by_number.setObjectName("by_number")
        self.gridLayout_4.addWidget(self.by_number, 5, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.by_name, 3, 0, 1, 1)
        self.separator_top = QtWidgets.QFrame(self.sort_frame)
        self.separator_top.setFrameShape(QtWidgets.QFrame.HLine)
        self.separator_top.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.separator_top.setObjectName("separator_top")
        self.gridLayout_4.addWidget(self.separator_top, 8, 0, 1, 1)
        self.set_condition = QtWidgets.QPushButton(self.sort_frame)
        self.set_condition.setObjectName("set_condition")
        self.gridLayout_4.addWidget(self.set_condition, 9, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.set_language.setText(_translate("MainWindow", "set language"))
        self.set_extra.setText(_translate("MainWindow", "set extra"))
        self.set_condition.setText(_translate("MainWindow", "set condition"))
        self.duplicate_line.setText(_translate("MainWindow", "duplicate line"))
